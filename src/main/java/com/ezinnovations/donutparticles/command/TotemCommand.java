...
public class TotemCommand implements CommandExecutor, TabCompleter {
    ...
    public TotemCommand(DonutParticles plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (!player.hasPermission("donutparticles.totem.toggle")) {
        ...
        settings.setTotemParticles(!settings.isTotemParticles());
        plugin.sendMessage(player, settings.isTotemParticles() ? "totem-enabled" : "totem-disabled");
        return true;
    }
